...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/Origine'), [0 => 'ROLE_USER'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/vin'), [0 => 'ROLE_USER'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/Vin'), [0 => 'ROLE_USER'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/Bouteille'), [0 => 'ROLE_USER'], NULL);
