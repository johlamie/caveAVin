...
CREATE TABLE origine(
	id_appellation INT AUTO_INCREMENT PRIMARY KEY,
...
('Limoux','Occitane'),
('Bandol','Provence'),
('Reuilly','Vallee de Loire et Centre '),
('Chinon','Vallee de Loire et Centre'),
('Patrimonio','Corse'),
('Champagne','Champagne'),
...
CREATE TABLE bouteille(
	id_vin INT NOT NULL,
	millesime INT(4) UNSIGNED CHECK (millesime <=2018),
	prix FLOAT UNSIGNED,
	quantite INT UNSIGNED NOT NULL,
	note INT UNSIGNED CHECK (note<=5),
	date_note DATE CHECK (date_note < CURDATE()),
